...
export class PlotService {
  ...
  private generatePlot01(person: string, planet: string): Plot {
    return {
  ...
  private generatePlot02(person: string, planet: string, starship: string): Plot {
    return {
  ...
  private generatePlot03(person: string, planet: string, vehicle: string): Plot {
    return {
  ...
  private generatePlot04(person: string, planet: string, species: string): Plot {
    return {
  ...
  private generatePlot05(person: string, planet: string, starship: string, vehicle: string): Plot {
    return {
  ...
  private generatePlot06(person: string, planet: string, starship: string, species: string): Plot {
    return {
  ...
  private generatePlot07(person: string, planet: string, vehicle: string, species: string): Plot {
    return {
  ...
  private generatePlot08(person: string, planet: string, starship: string, vehicle: string, species: string): Plot {
    return {
  ...
  private generate(person: string, planet: string, starship?: string, vehicle?: string, species?: string): Plot {
    ...
    if (!starship && !vehicle && !species) {
      return this.generatePlot01(person, planet);
    }
    else if (starship && !vehicle && !species) {
      return this.generatePlot02(person, planet, starship);
    }
    else if (!starship && vehicle && !species) {
      return this.generatePlot03(person, planet, vehicle);
    }
    else if (!starship && !vehicle && species) {
      return this.generatePlot04(person, planet, species);
    }
    else if(starship && vehicle && !species) {
      return this.generatePlot05(person, planet, starship, vehicle);
    }
    else if(starship && !vehicle && species) {
      return this.generatePlot06(person, planet, starship, species);
    }
    else if(!starship && vehicle && species) {
      return this.generatePlot07(person, planet, vehicle, species);
    }
    else {
      return this.generatePlot08(person, planet, (starship as string), (vehicle as string), (species as string));
    }
  }
   ...
   */
  generatePlot(person: string, planet: string, starship?: string, vehicle?: string, species?: string): Plot {

    const
      highlightedPerson = (this.highlight(person) as string),
      highlightedPlanet = (this.highlight(planet) as string),
      highlightedStarship = this.highlight(starship),
      highlightedVehicle = this.highlight(vehicle),
      highlightedSpecies = this.highlight(species);

    return this.generate(highlightedPerson, highlightedPlanet, highlightedStarship, highlightedVehicle, highlightedSpecies);
  }
}
